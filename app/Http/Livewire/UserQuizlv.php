...
class UserQuizlv extends Component
{
    ...
    public function showResults()
    {
        ...
        $this->currectQuizAnswers  = Quiz::where('quiz_header_id', $this->quizid->id)->where('is_correct', 1)->count();
    ...
    {
        $this->sections = Section::withcount('questions')->where('is_active','1')->orderBy('name')->get();
    ...
    public function getNextQuestion()
    {
        ...
        $question = Question::where('section_id', $this->sectionId)->whereNotIn('id', $this->answeredQuestions)->with('answers')->inRandomOrder()->first();
