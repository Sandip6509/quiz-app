                        ...
                        <label for="question-{{ $answer->id }}">
                            <div
                                ...
                                <span class="mr-2 font-extrabold"><input id="question-{{ $answer->id }}"
                                        value="{{ $answer->id . ',' . $answer->is_checked }}" wire:model="userAnswered"
                ...
                <div class="container px-5 py-5 mx-auto">
                    <div class="text-center mb-5 justify-center">
                        ...
                        <p class="text-md mt-10"> Dear <span class="font-extrabold text-blue-600 mr-2">
                                ...
                                href="{{ route('quiz.show', $quizid) }}">Show quiz details</a></p>
                    ...
                    <div class="p-4 md:w-1/2 w-full">
                        <form wire:submit.prevent="startQuiz">
                            ...
                            <div class="relative mx-full mb-4">
                                <select name="section" id="section_id" wire:model="sectionId"
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input wire:model="learningMode" id="learningMode" name="learningMode"
                                        type="checkbox"
                                        class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                </div>
                                <div class="ml-3 text-sm">
                                    <label for="learningMode" class="font-medium text-gray-700">Learning Mode?</label>
                                    <p class="text-gray-500">If checked, this will enable explanation tab for each
                                        question.</p>
                                </div>
                            </div>
