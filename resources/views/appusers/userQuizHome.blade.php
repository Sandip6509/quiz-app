        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mx-auto">
                <div class="flex justify-between items-center py-4">
                    <a href="{{route('quiz.create')}}" class=" tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-1 px-6 items-center">Take a New Quiz</a>
                                    ...
                                    <tbody class="capitalize bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-green-100">
                                                ...
                                                <div class="flex items-center">
                                                    <div class="ml-4">
                                                        <div class="text-sm font-medium text-gray-900">
                                                            <a class="text-white px-6 font-extrabold py-1 rounded-lg bg-blue-500 hover:bg-blue-600 hover:underline" href="{{route('quiz.show', $quiz->id)}}">
                                                                {{ $quiz->quiz_size}}
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <td class="sm:flex align-middle justify-center items-center px-6 py-1 text-right text-sm font-medium">
                                                <a href="{{route('quiz.show', $quiz->id)}}" class="text-green-500 hover:text-green-700">
                                                ...
                                                <form action="{{route('questions.destroy', $quiz->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
